...
;(function () {
    ...
    function loadDefaultCss() {
        ...
        $b.add(".calendar_default_main", "border: 1px solid #999;font-family: Tahoma, Arial, sans-serif; font-size: 12px;height:100%");
        ...
        $b.add(".calendar_default_alldayevent_inner,.calendar_default_event_inner", 'color: #fff; border: 1px solid #9dc8e8;');
        ...
        $b.add(".calendar_default_alldayevent_inner,.calendar_default_event_inner", 'background: #fff;background: -webkit-gradient(linear, left top, left bottom, from(#ffffff), to(#eeeeee));background: -webkit-linear-gradient(top, #1161b8 0%, #307ed1);background: -moz-linear-gradient(top, #ffffff 0%, #eeeeee);background: -ms-linear-gradient(top, #ffffff 0%, #eeeeee);background: -o-linear-gradient(top, #ffffff 0%, #eeeeee);background: linear-gradient(top, #ffffff 0%, #eeeeee);filter: progid:DXImageTransform.Microsoft.Gradient(startColorStr="#ffffff", endColorStr="#eeeeee");');
        ...
        this.getScrollableHeight = function () {
            switch (this.heightSpec) {
                case "Full":
                    ...
                    return $('.calendar_default_main').height()-20;
                case "BusinessHours":
                    var $0H = this.businessHoursSpan();
                    return $('.calendar_default_main').height()-64;
