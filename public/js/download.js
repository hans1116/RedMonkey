...
google.maps.__gjsload__('places', function (_) {
    var ax = function (a, b) {
        try {
            _.tc(window.HTMLInputElement, "HTMLInputElement")(a)
        } catch (c) {
            if (_.qc(c), !a)return
        }
        _.F("places_impl", (0, _.p)(function (c) {
            b = b || {};
            this.setValues(b);
            c.b(this, a);
            _.Ze(a)
        ...
        this.b = null;
        _.F("places_impl", (0, _.p)(function (a) {
            this.b = a.l()
        }, this))
    }, cx = function (a) {
        this.b = null;
        _.F("places_impl", (0, _.p)(function (b) {
            this.b = b.f(a)
        }, this))
    }, dx = function (a, b) {
        _.F("places_impl", (0, _.p)(function (c) {
    ...
    _.t(ax, _.y);
    ax.prototype.setTypes = _.rd("types", _.vc(_.Th));
    ax.prototype.setComponentRestrictions = _.rd("componentRestrictions", _.zc(_.rc({country: _.xc([_.Th, _.vc(_.Th)])}, !0)));
    _.sd(ax.prototype, {place: null, bounds: _.zc(_.od)});
    bx.prototype.getPlacePredictions = function (a, b) {
        _.F("places_impl", (0, _.p)(function () {
            this.b.getPlacePredictions(a, b)
        }, this))
    };
    bx.prototype.getPredictions = bx.prototype.getPlacePredictions;
    bx.prototype.getQueryPredictions = function (a, b) {
        _.F("places_impl", (0, _.p)(function () {
    ...
    _.k.search = cx.prototype.nearbySearch;
    ...
    _.t(dx, _.y);
    _.sd(dx.prototype, {places: null, bounds: _.zc(_.od)});
    _.Ub.google.maps.places = {
        PlacesService: cx,
        PlacesServiceStatus: {
            OK: _.ga,
            UNKNOWN_ERROR: _.ja,
