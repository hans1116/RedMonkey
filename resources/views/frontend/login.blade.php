...
<html lang="en" class="height-100 html-login"><!--<![endif]--><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    /* Replace 'APP_ID' with your app ID */
            window.intercomSettings = {"app_id":"vvvxqg7a","language_override":"en"};
            /* Replace 'APP_ID' with your app ID */
            (function(){ var w=window;var ic=w.Intercom;if(typeof ic==="function"){ ic('reattach_activator');ic('update',intercomSettings);}else{ var d=document;var i=function(){ i.c(arguments)};i.q=[];i.c=function(args){ i.q.push(args)};w.Intercom=i;function l(){ var s=d.createElement('script');s.type='text/javascript';s.async=true;s.src='https://widget.intercom.io/widget/vvvxqg7a';var x=d.getElementsByTagName('script')[0];x.parentNode.insertBefore(s,x);}if(w.attachEvent){ w.attachEvent('onload',l);}else{ w.addEventListener('load',l,false);}}})()
        </script>
    ...
    <div class="header-inner">
        <p class="header-logo">
            <a href="https://localhost/">
                <img src="./img/reservio-logo.png" alt="Reservio" width="183" height="38">
            </a>
        </p>
        ...
        <div class="header-text">
            ...
            <div class="header-text-item menu-main">
                <button class="menu-main-btn">Menu</button>
            </div>
        </div>
    </div>
</div>
...
<div class="menu-main-box">
    ...
    <button class="menu-main-close">Close</button>
</div>
</div> 
    <div class="box-login">
        <div class="box-login-inner">
            ...
            <p class="footer-copyright text-center">Copyright 2012 - 2017 Reservio. All rights reserved.</p>
        </div>
    </div>
...
<iframe id="intercom-frame" style="display: none;"></iframe><div id="intercom-container" style="position: fixed; width: 0px; height: 0px; bottom: 0px; right: 0px; z-index: 2147483647;">
