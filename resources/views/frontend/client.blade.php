            ...
            <div class="two-col-panel clients-panel">
                ...
                <div class="clients-export white-paper">
                    ...
                    <ul class="clients-export-options">
                        <li class="csv"><a data-bind="click: $root.importClientsClicked.bind($root)" href="https://app.reservio.com/en/login/#" title="Import from CSV">csv</a></li>
                        <li class="gmail"><a href="https://app.reservio.com/contacts/import-gmail-contacts/" title="Import from Gmail">Gmail</a></li>
                    </ul>
                </div>
                <div class="clients-export white-paper">
                        <h3>
                        ...
                        <ul class="clients-export-options">
                            <li class="csv"><a data-bind="click: $root.exportClientsCsvClicked.bind($root)" href="https://app.reservio.com/en/login/#" title="Export to CSV">csv</a></li>
                            <li class="pdf"><a data-bind="click: $root.exportClientsPdfClicked.bind($root)" href="https://app.reservio.com/en/login/#" title="Export to PDF">pdf</a></li>
                        </ul>
                </div>
    ...
    <ul class="clients-list" data-bind="foreach: clients, delegatedHandler: &#39;click&#39;">
        ...
        <li class="client-card">
            <a href="https://app.reservio.com/en/login/#/clients/detail/1" data-bind="attr: {href: &#39;#/clients/detail/&#39;+id()}">
                <div class="client-card-picture" data-bind="profilePicture: $data"><div class="profile-pic c1">He</div></div>
                <ul>
                    <li class="name">
        ...
        <li class="client-card">
            <a href="https://app.reservio.com/en/login/#/clients/detail/2" data-bind="attr: {href: &#39;#/clients/detail/&#39;+id()}">
                <div class="client-card-picture" data-bind="profilePicture: $data"><div class="profile-pic c2">Hi</div></div>
                <ul>
                    <li class="name">
                    ...
                    <li data-bind="text: email"></li>
                    <li data-bind="text: phone">1112341223</li>
                </ul>
            </a>
        </li>
        <!-- /ko -->
